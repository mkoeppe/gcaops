...
class FormalityGraph:
    ...
    def _insertion_graphs(self, position, other, max_out_degree=None, max_aerial_in_degree=None, skip_attaching_to_ground=False):
        ...
        #. Insertion into an aerial vertex::
            ...
            sage: edge_in_air = FormalityGraph(0, 3, [(0, 1)])
            sage: list(g._insertion_graphs(3, edge_in_air, max_out_degree=2))
            [FormalityGraph(3, 3, [(3, 0), (4, 1), (4, 2), (3, 4)]),
             FormalityGraph(3, 3, [(3, 0), (4, 1), (5, 2), (3, 4)]),
             FormalityGraph(3, 3, [(3, 0), (5, 1), (4, 2), (3, 4)]),
             FormalityGraph(3, 3, [(3, 0), (5, 1), (5, 2), (3, 4)]),
             FormalityGraph(3, 3, [(4, 0), (3, 1), (4, 2), (3, 4)]),
             FormalityGraph(3, 3, [(4, 0), (3, 1), (5, 2), (3, 4)]),
             FormalityGraph(3, 3, [(4, 0), (4, 1), (3, 2), (3, 4)]),
             FormalityGraph(3, 3, [(4, 0), (4, 1), (5, 2), (3, 4)]),
             FormalityGraph(3, 3, [(4, 0), (5, 1), (3, 2), (3, 4)]),
             FormalityGraph(3, 3, [(4, 0), (5, 1), (4, 2), (3, 4)]),
             FormalityGraph(3, 3, [(4, 0), (5, 1), (5, 2), (3, 4)]),
             FormalityGraph(3, 3, [(5, 0), (3, 1), (4, 2), (3, 4)]),
             FormalityGraph(3, 3, [(5, 0), (3, 1), (5, 2), (3, 4)]),
             FormalityGraph(3, 3, [(5, 0), (4, 1), (3, 2), (3, 4)]),
             FormalityGraph(3, 3, [(5, 0), (4, 1), (4, 2), (3, 4)]),
             FormalityGraph(3, 3, [(5, 0), (4, 1), (5, 2), (3, 4)]),
             FormalityGraph(3, 3, [(5, 0), (5, 1), (3, 2), (3, 4)]),
             FormalityGraph(3, 3, [(5, 0), (5, 1), (4, 2), (3, 4)])]
        """
